...
import n.tony.api.MeterCollectorService
...
class MeterCollectorServiceIntegrationSpec
    extends AnyWordSpec
    with Matchers
  ...
  private val client = testKit.getGrpcClient(classOf[MeterCollectorService])

  "MeterCollectorService" must {
